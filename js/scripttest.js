...
async function callImdb()  {
	const response = await fetch("https://imdb-internet-movie-database-unofficial.p.rapidapi.com/film/tt0770828", {
	headers: {
		"x-rapidapi-host": "imdb-internet-movie-database-unofficial.p.rapidapi.com",
		"x-rapidapi-key": "3cbd8fe6e8msh154d62eb58c16c4p1fe8d5jsnc9c87e469b9c"
	}
...
async function callMovieDatabase() {
	...
	try{
		const url = ("https://imdb-internet-movie-database-unofficial.p.rapidapi.com/film/tt0770828", options);
